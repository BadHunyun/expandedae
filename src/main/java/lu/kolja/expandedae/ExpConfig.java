...
public class ExpConfig {
    ...
    private static final ForgeConfigSpec.IntValue MAX_CONTROLLER_SIZE = BUILDER
    ...
    private static final ForgeConfigSpec.BooleanValue IGNORE_CONTROLLER_RULES = BUILDER
